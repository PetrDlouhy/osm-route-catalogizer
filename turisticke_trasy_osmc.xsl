...
<xsl:template match="relation[tag/@v = 'foot' or tag/@v='hiking' or tag/@v='ski' or tag/@v='horse']">
		...
		<xsl:choose>
			...
			<xsl:when test="$kct_type = 'local' and ($osmc_symbol_type != 'right_up_triangle' and $osmc_background_color != 'white')">
				<xsl:text>no</xsl:text>
			</xsl:when>
			...
			<xsl:when test="$kct_type = 'spring' and ($osmc_symbol_type != 'halfcircle' or $osmc_background_color != 'white')">
				<xsl:text>no</xsl:text>
			</xsl:when>
			<xsl:when test="$kct_type = 'interesting_object' and ($osmc_symbol_type != 'upside_T' or $osmc_background_color != 'white')">
				<xsl:text>no</xsl:text>
			</xsl:when>
